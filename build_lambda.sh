...
cp lambda/sla_casos.py "$BUILD_DIR/"
cp lambda/api_externa.py "$BUILD_DIR/"
cp lambda/informe_casos.py "$BUILD_DIR/"
cp lambda/informe_pdf.py "$BUILD_DIR/"
cp lambda/ros.py "$BUILD_DIR/"
