-- Duplicado B2B de individual_aml_in.sql. Misma lógica, misma tabla
-- (cca.wallet_deposit) — identidad resuelta contra company.company en vez de
...
INNER JOIN target_companies tc ON ti.customer_id = tc.company_id
...
ORDER BY tc.company_name, w.deposit_date DESC
