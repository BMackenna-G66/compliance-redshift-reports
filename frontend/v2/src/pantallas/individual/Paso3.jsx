...
export function Paso3({ api, perfil, email, texto, alCambiarTexto }) {
  /* El texto pegado vive en el contenedor, no acá: el paso 1 lo llena con lo
     que encontró en el reporte de Salesforce, y perderlo al cambiar de
     pestaña obligaría a volver a importar el archivo. */
  const setTexto = alCambiarTexto;
